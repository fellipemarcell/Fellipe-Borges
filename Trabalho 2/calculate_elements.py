...
def calculate_elements(type_element):
    ...
    if type_element is None:
        raise ValueError("Type element must be a string.")
    ...
    if len(faces) == 0:
        raise ValueError("Faces must be a list of lists.")
...
faces = calculate_elements(type_element)
